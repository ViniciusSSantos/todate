              ...
              return(
                  <main>
                      <ol className="gradient-list" key = {event.id} >
                          ...
                          <button className="confirm-button" onClick = {() => HandleDelete(event.id)}>aperte aqui para deletar</button>                         
                      ...
                      <Collapsible trigger="modifique aqui" onOpen = {() => setId(event.id)}>
                      <form onSubmit = {HandleUpdate} className="create-user-form">
                            <fieldset>
                                <legend>modifique evento</legend>  
